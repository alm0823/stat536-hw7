...
No Year, 1st Order Harmonic $y_{t} = \beta_{0} + \beta_{1}cos(2\pif(t)) + 
...
No Year, 5th Order Harmonic $y_{t} = \beta_{0} + \Sigma_{i=1:5} \beta_{i}cos(2i\pif(t)) + 
...
\hlstd{mod_nt.sh1} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}beta_\{0\} + \textbackslash{}\textbackslash{}beta_\{1\}cos(2\textbackslash{}\textbackslash{}pif(t)) + 
                    \textbackslash{}\textbackslash{}beta_\{2\}sin(2\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_lt.sh1} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + 
                    \textbackslash{}\textbackslash{}beta_\{1\}cos(2\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}beta_\{2\}sin(2\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_qt.sh1} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + 
                    \textbackslash{}\textbackslash{}gamma_\{2\}year^\{2\} + \textbackslash{}\textbackslash{}beta_\{1\}cos(2\textbackslash{}\textbackslash{}pif(t)) + 
                    \textbackslash{}\textbackslash{}beta_\{2\}sin(2\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_nt.sh5} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}beta_\{0\} + \textbackslash{}\textbackslash{}Sigma_\{i=1:5\} \textbackslash{}\textbackslash{}beta_\{i\}cos(2i\textbackslash{}\textbackslash{}pif(t)) + 
                    \textbackslash{}\textbackslash{}psi_\{i\}sin(2i\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_lt.sh5} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + \textbackslash{}\textbackslash{}Sigma_\{i=1:5\} 
                    \textbackslash{}\textbackslash{}beta_\{i\}cos(2i\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}psi_\{i\}sin(2i\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_qt.sh5} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + \textbackslash{}\textbackslash{}gamma_\{1\}year^\{2\} + 
                    \textbackslash{}\textbackslash{}Sigma_\{i=1:5\} \textbackslash{}\textbackslash{}beta_\{i\}cos(2i\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}psi_\{i\}sin(2i\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{modar1_year} \hlkwb{<-} \hlkwd{lapply}\hlstd{(ar1sim[,}\hlnum{1}\hlopt{:}\hlnum{1000}\hlstd{],} \hlkwa{function}\hlstd{(}\hlkwc{a}\hlstd{)\{}\hlkwd{fnt_ar1}\hlstd{(Data1}\hlopt{$}\hlstd{Year,a)\})}

\hlstd{modma1_year} \hlkwb{<-} \hlkwd{lapply}\hlstd{(ar1sim[,}\hlnum{1}\hlopt{:}\hlnum{1000}\hlstd{],} \hlkwa{function}\hlstd{(}\hlkwc{a}\hlstd{)\{}\hlkwd{fnt_ma1}\hlstd{(Data1}\hlopt{$}\hlstd{Year,a)\})}

\hlstd{ciar1_year} \hlkwb{<-} \hlkwd{lapply}\hlstd{(modar1_year, confint)}
\hlstd{cima1_year} \hlkwb{<-} \hlkwd{lapply}\hlstd{(modma1_year, confint)}

\hlstd{fnt_coeff} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{t}\hlstd{)\{}
  \hlkwd{coef}\hlstd{(}\hlkwd{summary}\hlstd{(modma1_year}\hlopt{$}\hlstd{t))[}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{]}
\hlstd{\}}

\hlstd{Xmatrix} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlkwd{rep}\hlstd{(}\hlstr{"X"}\hlstd{,}\hlnum{1000}\hlstd{))}
\hlstd{nums} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{1000}\hlstd{)}
\hlstd{nums} \hlkwb{<-} \hlkwd{as.character}\hlstd{(nums)}
\hlstd{col_year} \hlkwb{<-} \hlkwd{paste}\hlstd{(Xmatrix,nums,} \hlkwc{sep} \hlstd{=} \hlstr{""}\hlstd{)}

\hlstd{modma1_year}\hlopt{$}\hlstd{col_year[}\hlnum{1}\hlstd{]}

\hlstd{coefar1_year} \hlkwb{<-} \hlkwd{lapply}\hlstd{(modar1_year, fnt_coeff)}
\hlstd{coefma1_year} \hlkwb{<-} \hlkwd{lapply}\hlstd{(mod)}


\hlstd{gls_ar1_out} \hlkwb{<-} \hlkwd{coef}\hlstd{(gls_ar1_obs)[}\hlnum{2}\hlstd{]}

\hlstd{gls_ma_obs} \hlkwb{<-} \hlkwd{gls}\hlstd{(PropDays} \hlopt{~} \hlstd{Year,} \hlkwc{data} \hlstd{= Data1,} \hlkwc{correlation} \hlstd{=} \hlkwd{corARMA}\hlstd{())}
...
\hlcom{#error ??}
\hlstd{gls_ma} \hlkwb{<-} \hlkwd{replicate}\hlstd{(}\hlnum{1000}\hlstd{,} \hlkwd{coef}\hlstd{(}\hlkwd{gls}\hlstd{(PropDays} \hlopt{~} \hlkwd{shuffle}\hlstd{(Year),} \hlkwc{data} \hlstd{= Data1,} \hlkwc{correlation} \hlstd{=} \hlkwd{corARMA}\hlstd{()))[}\hlnum{2}\hlstd{])}
...
\hlcom{#pvalue_ma <- (length(which(gls_ma <= gls_ma_out)) + length(which(gls_ma >= -gls_ma_out)))/length(gls_ma)}

\hlcom{#taken from hw6 solutions}
\hlkwd{arima.sim}\hlstd{(}\hlkwc{n}\hlstd{=}\hlnum{109}\hlstd{,}\hlkwc{model}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{ar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0.6}\hlstd{)),}\hlkwc{sd}\hlstd{=}\hlkwd{sqrt}\hlstd{(}\hlnum{0.0006664659}\hlstd{))}
\end{alltt}
\end{kframe}
\end{knitrout}
