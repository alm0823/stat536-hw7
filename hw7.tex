...
\begin{tabular}{rl}
 ...
 &   \\ 
  \hline
Quadratic Year, 5th Order Harmonic & \$y\_\{t\} = $\backslash$gamma\_\{0\} + $\backslash$gamma\_\{1\}year + $\backslash$gamma\_\{1\}year\verb|^|\{2\} + $\backslash$Sigma\_\{i=1:5\} $\backslash$beta\_\{i\}cos(2i$\backslash$pif(t)) + $\backslash$psi\_\{i\}sin(2i$\backslash$pif(t)) + e\_\{t\}\$ \\ 
  Linear Year, 5th Order Harmonic & \$y\_\{t\} = $\backslash$gamma\_\{0\} + $\backslash$gamma\_\{1\}year + $\backslash$Sigma\_\{i=1:5\} $\backslash$beta\_\{i\}cos(2i$\backslash$pif(t)) + $\backslash$psi\_\{i\}sin(2i$\backslash$pif(t)) + e\_\{t\}\$ \\ 
  No Year, 5th Order Harmonic & \$y\_\{t\} = $\backslash$beta\_\{0\} + $\backslash$Sigma\_\{i=1:5\} $\backslash$beta\_\{i\}cos(2i$\backslash$pif(t)) + $\backslash$psi\_\{i\}sin(2i$\backslash$pif(t)) + e\_\{t\}\$ \\ 
  Quadratic Year, 1st Order Harmonic & \$y\_\{t\} = $\backslash$gamma\_\{0\} + $\backslash$gamma\_\{1\}year + $\backslash$gamma\_\{2\}year\verb|^|\{2\} + $\backslash$beta\_\{1\}cos(2$\backslash$pif(t)) + $\backslash$beta\_\{2\}sin(2$\backslash$pif(t)) + e\_\{t\}\$ \\ 
  Linear Year, 1st Order Harmonic & \$y\_\{t\} = $\backslash$gamma\_\{0\} + $\backslash$gamma\_\{1\}year + $\backslash$beta\_\{1\}cos(2$\backslash$pif(t)) + $\backslash$beta\_\{2\}sin(2$\backslash$pif(t)) + e\_\{t\}\$ \\ 
  No Year, 1st Order Harmonic & \$y\_\{t\} = $\backslash$beta\_\{0\} + $\backslash$beta\_\{1\}cos(2$\backslash$pif(t)) + $\backslash$beta\_\{2\}sin(2$\backslash$pif(t)) + e\_\{t\}\$ \\ 
  Quadratic Year, Seasonal Means & \$y\_\{t\}\$ = \$$\backslash$gamma\_\{1\}year + $\backslash$gamma\_\{2\}year\verb|^|\{2\} + $\backslash$beta\_\{1\}jan.ind + $\backslash$beta\_\{2\}feb.ind + $\backslash$beta\_\{3\}mar.ind + $\backslash$beta\_\{4\}apr.ind + $\backslash$beta\_\{5\}may.ind + $\backslash$beta\_\{6\}june.ind + $\backslash$beta\_\{7\}july.ind + $\backslash$beta\_\{8\}aug.ind + $\backslash$beta\_\{9\}sept.ind +
               $\backslash$beta\_\{10\}oct.ind + $\backslash$beta\_\{11\}nov.ind + $\backslash$beta\_\{12\}dec.ind + e\_\{t\}\$ \\ 
  Linear Year, Seasonal Means & \$y\_\{t\}\$ = \$$\backslash$gamma\_\{1\}year + $\backslash$beta\_\{1\}jan.ind  + $\backslash$beta\_\{2\}feb.ind + $\backslash$beta\_\{3\}mar.ind + $\backslash$beta\_\{4\}apr.ind + 
               $\backslash$beta\_\{5\}may.ind + $\backslash$beta\_\{6\}june.ind + $\backslash$beta\_\{7\}july.ind + $\backslash$beta\_\{8\}aug.ind + $\backslash$beta\_\{9\}sept.ind +
               $\backslash$beta\_\{10\}oct.ind + $\backslash$beta\_\{11\}nov.ind + $\backslash$beta\_\{12\}dec.ind + e\_\{t\}\$ \\ 
  No Year, Seasonal Means & \$y\_\{t\}\$ = \$$\backslash$beta\_\{1\}jan.ind + $\backslash$beta\_\{2\}feb.ind + $\backslash$beta\_\{3\}mar.ind + $\backslash$beta\_\{4\}apr.ind + 
               $\backslash$beta\_\{5\}may.ind + $\backslash$beta\_\{6\}june.ind + $\backslash$beta\_\{7\}july.ind + $\backslash$beta\_\{8\}aug.ind + $\backslash$beta\_\{9\}sept.ind +
               $\backslash$beta\_\{10\}oct.ind + $\backslash$beta\_\{11\}nov.ind + $\backslash$beta\_\{12\}dec.ind + e\_\{t\}\$ \\ 
  Quadratic Year, No Seasonality & \$y\_\{t\}\$ = \$$\backslash$gamma\_\{o\} + $\backslash$gamma\_\{1\}year + $\backslash$gamma\_\{1\}year\verb|^|\{2\} + e\_\{t\}\$ \\ 
  Linear Year, No Seasonality & \$y\_\{t\}\$ = \$$\backslash$gamma\_\{o\} + $\backslash$gamma\_\{1\}year + e\_\{t\}\$ \\ 
  No Year, No Seasonality & \$y\_\{t\}\$ = \$eta\_\{o\} + e\_\{t\}\$ \\ 
   \hline
\end{tabular}
\end{table}
% latex table generated in R 3.3.1 by xtable 1.8-2 package
% Thu Oct 27 11:45:29 2016
\begin{table}[H]
\centering
\begin{tabular}{lrrrr}
  \hline
...
No Year, 1st Order Harmonic $y_{t} = \beta_{0} + \beta_{1}cos(2\pif(t)) + \beta_{2}sin(2\pif(t)) + e_{t}$

Linear Year, 1st Order Harmonic $y_{t} = \gamma_{0} + \gamma_{1}year + \beta_{1}cos(2\pif(t)) + \beta_{2}sin(2\pif(t)) + e_{t}$

Quadratic year, 1st Order Harmonic $y_{t} = \gamma_{0} + \gamma_{1}year + \gamma_{2}year^{2} + \beta_{1}cos(2\pif(t)) + \beta_{2}sin(2\pif(t)) + e_{t}$

No Year, 5th Order Harmonic $y_{t} = \beta_{0} + \Sigma_{i=1:5} \beta_{i}cos(2i\pif(t)) + \psi_{i}sin(2i\pif(t)) + e_{t}$

Linear Year, 5th Order Harmonic $y_{t} = \gamma_{0} + \gamma_{1}year + \Sigma_{i=1:5} \beta_{i}cos(2i\pif(t)) + \psi_{i}sin(2i\pif(t)) + e_{t}$

Quadratic Year, 5th Order Harmonic $y_{t} = \gamma_{0} + \gamma_{1}year + \gamma_{1}year^{2} + \Sigma_{i=1:5} \beta_{i}cos(2i\pif(t)) + \psi_{i}sin(2i\pif(t)) + e_{t}$
...
{\ttfamily\noindent\color{warningcolor}{Warning in text.default(1, at = c(seq(0, 80, by = 13.33)), labels = c(seq(min(mex\$year), : "{}at"{} is not a graphical parameter}}

{\ttfamily\noindent\color{warningcolor}{Warning in text.default(1, at = c(seq(0, 80, by = 13.33)), labels = c(seq(min(mex\$year), : "{}str"{} is not a graphical parameter}}\end{kframe}
...
\item%5
{\it Revisit your simulation with an AR(1) from HW 6 # 10. Consider fitting a model with autocorrelation in it using ``gls" from the ``nlme" package that accounts for an MA(1) error and another that accounts for an AR(1) error. Run your simulation code, extracting the p-values from the two model summaries and estimate the type I error rate in each situation and compare it to what you get from the regular linear model. 

\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in abline(lm.Year, lwd = 2): object 'lm.Year' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in abline(model1s, col = "{}purple"{}, lty = 2, lwd = 2): object 'model1s' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in abline(a = zyp.Year\$coefficients[1], b = zyp.Year\$coefficients[2], : object 'zyp.Year' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in getGroupsFormula.default(correlation): 'form' argument must be a formula}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in coef(gls\_ma\_obs): object 'gls\_ma\_obs' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in getGroupsFormula.default(correlation): 'form' argument must be a formula}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in rand.gen(n.start, ...): argument is missing, with no default}}\end{kframe}
\end{knitrout}
...
\hlstd{mod_nt.sh1} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}beta_\{0\} + \textbackslash{}\textbackslash{}beta_\{1\}cos(2\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}beta_\{2\}sin(2\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_lt.sh1} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + \textbackslash{}\textbackslash{}beta_\{1\}cos(2\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}beta_\{2\}sin(2\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_qt.sh1} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + \textbackslash{}\textbackslash{}gamma_\{2\}year^\{2\} + \textbackslash{}\textbackslash{}beta_\{1\}cos(2\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}beta_\{2\}sin(2\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_nt.sh5} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}beta_\{0\} + \textbackslash{}\textbackslash{}Sigma_\{i=1:5\} \textbackslash{}\textbackslash{}beta_\{i\}cos(2i\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}psi_\{i\}sin(2i\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_lt.sh5} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + \textbackslash{}\textbackslash{}Sigma_\{i=1:5\} \textbackslash{}\textbackslash{}beta_\{i\}cos(2i\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}psi_\{i\}sin(2i\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{mod_qt.sh5} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"$y_\{t\} = \textbackslash{}\textbackslash{}gamma_\{0\} + \textbackslash{}\textbackslash{}gamma_\{1\}year + \textbackslash{}\textbackslash{}gamma_\{1\}year^\{2\} + \textbackslash{}\textbackslash{}Sigma_\{i=1:5\} \textbackslash{}\textbackslash{}beta_\{i\}cos(2i\textbackslash{}\textbackslash{}pif(t)) + \textbackslash{}\textbackslash{}psi_\{i\}sin(2i\textbackslash{}\textbackslash{}pif(t)) + e_\{t\}$"}\hlstd{)}
...
\hlstd{df_all}\hlopt{$}\hlstd{deltaAIC} \hlkwb{<-} \hlkwd{round}\hlstd{(}\hlkwd{as.numeric}\hlstd{(}\hlkwd{as.character}\hlstd{(df_all}\hlopt{$}\hlstd{AIC)),} \hlnum{2}\hlstd{)} \hlopt{-} \hlkwd{round}\hlstd{(}\hlkwd{as.numeric}\hlstd{(}\hlkwd{as.character}\hlstd{(df_all}\hlopt{$}\hlstd{AIC[}\hlnum{1}\hlstd{])),} \hlnum{2}\hlstd{)}
...
\hlkwd{print}\hlstd{(}\hlkwd{xtable}\hlstd{(all_mod))}
