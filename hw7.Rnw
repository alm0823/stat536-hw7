...
mod_lt.ns <- "$y_{t}$ = $\\gamma_{o} + \\gamma_{1}year + e_{t}$"
...
mod_qt.ns <- "$y_{t}$ = $\\gamma_{o} + \\gamma_{1}year + \\gamma_{1}year^{2} + e_{t}$"
...
mod_lt.sm <- "$y_{t}$ = $\\gamma_{1}year + \\beta_{1}jan.ind  + \\beta_{2}feb.ind + \\beta_{3}mar.ind + \\beta_{4}apr.ind + 
              \\beta_{5}may.ind + \\beta_{6}june.ind + \\beta_{7}july.ind + \\beta_{8}aug.ind + \\beta_{9}sept.ind +
              \\beta_{10}oct.ind + \\beta_{11}nov.ind + \\beta_{12}dec.ind + e_{t}$"
...
mod_qt.sm <- "$y_{t}$ = $\\gamma_{1}year + \\gamma_{2}year^{2} + \\beta_{1}jan.ind + \\beta_{2}feb.ind + \\beta_{3}mar.ind +
...
mod_nt.sh1 <- "$y_{t} = \\beta_{0} + \\beta_{1}cos(2\\pi f(t)) + \\beta_{2}sin(2\\pi f(t)) + e_{t}$"
...
mod_lt.sh1 <- "$y_{t} = \\gamma_{0} + \\gamma_{1}year + \\beta_{1}cos(2\\pi f(t)) + \\beta_{2}sin(2\\pi f(t)) + e_{t}$"
...
mod_qt.sh1 <- "$y_{t} = \\gamma_{0} + \\gamma_{1}year + \\gamma_{2}year^{2} + \\beta_{1}cos(2\\pi f(t)) + \\beta_{2}sin(2\\pi f(t)) + e_{t}$"
...
mod_nt.sh5 <- "$y_{t} = \\beta_{0} + \\Sigma_{i=1:5} \\beta_{i}cos(2i\\pi f(t)) + \\psi_{i}sin(2i\\pi f(t)) + e_{t}$"
...
mod_lt.sh5 <- "$y_{t} = \\gamma_{0} + \\gamma_{1}year + \\Sigma_{i=1:5} \\beta_{i}cos(2i\\pi f(t)) + \\psi_{i}sin(2i\\pi f(t)) + e_{t}$"
...
mod_qt.sh5 <- "$y_{t} = \\gamma_{0} + \\gamma_{1}year + \\gamma_{1}year^{2} +
