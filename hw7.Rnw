...
nt.sm <- data.frame("No Year, Seasonal Means", df_nt.sm, aic_nt.sm)
...
lt.sm <- data.frame("Linear Year, Seasonal Means", df_lt.sm, aic_lt.sm)
...
qt.sm <- data.frame("Quadratic Year, Seasonal Means", df_qt.sm, aic_qt.sm)
